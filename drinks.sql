...
--
-- Host: localhost
-- Generation Time: Nov 14, 2019 at 02:09 PM
...
CREATE TABLE `users` (
  ...
  `avatar` varchar(50) COLLATE utf8_spanish2_ci NOT NULL DEFAULT 'defaultAvatar.jpg',
...
(1, 'admin', 'admin@drinks.com', '$2y$10$cD4TJrZTnhoUunIeCciLlev.egUqS4kgWDW7Rn9tQepJuBHUdx5p.', 'defaultAvatar.jpg', 1);
